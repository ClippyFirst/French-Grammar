...
- особу та займенники;
- часи й часову перспективу;
- слова місця й часу;
- тип переданого висловлювання;
- пунктуацію.
...
- немає знака питання всередині речення;
- немає інверсії підмета і дієслова;
- зберігається питальне слово, якщо воно було в прямому питанні.
...
Академія французької мови зазначає, що після головного дієслова в минулому для нейтральної нормативної мови зазвичай перевага надається відповідному минулому часу, але вибір залежить і від змісту та актуальності повідомлення. citeturn0search14
...
# FR-491 — Часові та просторові вказівники

Під час переходу до непрямої мови можуть змінюватися деїктичні слова.
...
# FR-492 — Накази, прохання та заборони
...
# FR-493 — Пунктуація та непряма мова в живому тексті
...
# FR-494 — Система перетворення: алгоритм і контрасти

## Алгоритм

Коли потрібно перетворити пряму мову на непряму:

### 1. Визначте тип висловлювання
...
### 4. Визначте часову перспективу

Якщо головна частина в минулому, перевірте:
...
# Українсько-французькі контрасти
...
### 4. Механічна заміна всіх présent

Не:

> «після минулого головного дієслова présent завжди заборонений».
...
- [Futur dans le passé](./futur-dans-passe)
