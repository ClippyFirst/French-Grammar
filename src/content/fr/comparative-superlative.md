---
title_uk: "Порівняльний і найвищий ступінь"
...
Друге речення прямо встановлює нижчий ступінь.

Ця різниця важлива і для перекладу, і для логічного аналізу.

## 7. De plus en plus та de moins en moins
...
## 12. Plus без повторення прикметника
