---
title_uk: "Прийменник DANS у французькій мові: повний довідник для українськомовних"
title_fr: "La préposition DANS en français"
description_uk: "Детальний посібник з використання прийменника DANS у французькій мові. Дізнайтеся про всі випадки вживання: місце (всередині), час (через), стан, напрямок та інші. З порівняннями, прикладами та вправами для українськомовних."
...
```
❌ dans le maison → ✅ dans la maison (у будинку)
❌ dans un heure → ✅ dans une heure (через годину)
❌ dans Paris → ✅ à Paris (у Парижі)
```
...
## 🔍 Порівняння: DANS vs À vs EN vs DE
...
### 1. Плутання DANS та À
```
❌ Je suis à la maison. (коли мова йде про місцеперебування у будинку) → ✅ Je suis dans la maison.
...
### 2. Плутання DANS та EN з транспортом
```
❌ Je suis dans le bus. (коли мова йде про пересування) → ✅ Je voyage en bus.
...
| DANS | À |
|------|---|
| dans la maison (у будинку — всередині) | à la maison (удома — у свій будинок) |
| dans le sac (у сумці — всередині) | à l'école (у школу — напрямок) |
...
1. Je suis à la maison. (у будинку, всередині)
2. Il part en cinq minutes.
3. Le livre est de la table.
4. Elle entre à la pièce.
5. Nous sommes dans le Paris.
...
1. Кіт спить у кошику.
2. Я побачу тебе через годину.
3. Діти граються у саду.
4. Ключі у моїй сумці.
5. Ми у труднощах.
...
## 📚 Додаткові ресурси
- [Прийменник À](prepositions-a) — порівняння з DANS
- [Прийменник DE](prepositions-de) — різниця з DANS
- [Прийменник EN](prepositions-en) — коли вживати EN
