---
title_uk: "Faire: дія, погода, сталі конструкції та каузативність"
title_fr: "Le verbe faire"
...
## 6. Faire + infinitif: каузативність
...
- хто є ініціатором;
- хто виконує інфінітивну дію;
- які займенники належать до кожного дієслова;
- як змінюється порядок слів.

Це окрема тема, не зводьте її до одного перекладу «змусити».

## 7. Faire + infinitif та український контраст

Українська може використовувати:
...
- [Présent](./present)
- [Інфінітивні конструкції](./infinitive)
- [Пасив](./passive)
- [Avoir](./avoir)
