---
title_uk: "Підрядність і підрядні речення у французькій мові"
title_fr: "La subordination et les propositions subordonnées"
...
- передавати зміст думки, знання, повідомлення чи питання;
- характеризувати іменник;
- виражати причину;
- показувати наслідок;
- називати мету;
- виражати протиставлення або поступку;
- задавати умову;
- визначати час події.

---

# 1. FR-475 — Що таке підрядність

## 1.1. Головна та підрядна частини
...
## 1.3. Підрядність і juxtaposition
...
# 2. FR-476 — Основні типи підрядних

Підрядні конструкції не утворюють одного однорідного класу.
...
# 6. FR-480 — Наслідкові підрядні

## 6.1. Основна конструкція
...
Граматична структура — різна.

---

# 9. FR-483 — Допустові підрядні
...
# 12. Один сполучник — кілька значень

Не вчіть французькі сполучники як словник «одне слово = одне значення».
...
# 13. Indicatif чи subjonctif?

Вибір способу не визначається простим правилом «усі підрядні = indicatif» або «всі підрядні = subjonctif».
...
# 16. Типові помилки україномовних студентів
...
# 17. Практичний алгоритм

Коли потрібно побудувати або проаналізувати складне французьке речення:
...
### Крок 3. Визначте синтаксичний тип
