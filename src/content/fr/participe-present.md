---
title_uk: "Participe présent: форма, вживання та відмінність від gérondif"
...
Точне відношення — часове, причинне, умовне тощо — визначає контекст.
...
Це різні форми з різними синтаксичними ролями.
...
У частини дієслів participe présent та adjectif verbal мають різне написання.
...
Такі пари не варто пояснювати простим правилом «-ant = дієприкметник». Académie française окремо звертає увагу на розбіжності після **-guer / -quer** та на окремі прикметники на **-ent**. citeturn0search4

У довіднику це слід розглядати як окрему орфографічну та лексико-граматичну проблему.

## 8. Український контраст

Українська може передавати participe présent:
