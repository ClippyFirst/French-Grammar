...
У першому випадку форма має дієслівну функцію, у другому — прикметникову.
...
Для прономінальних дієслів саме функція **se** та наявність COD визначають багато випадків узгодження. Не використовуйте правило «se = автоматичне узгодження з підметом».

Докладніше: [узгодження participe passé у прономінальних дієсловах](./pronominal-participe-agreement) та [прономінальні дієслова](./pronominal-verbs).
