...
На часовій осі: **Paul est parti → je suis arrivé**. Форма *était parti* показує, що відхід передує минулій точці відліку — моєму приходу.
...
## Відносна часова локалізація

Plus-que-parfait належить до тієї самої логіки, що й інші складені часи з відносною точкою відліку: він показує ситуацію як таку, що вже відбулася до релевантної минулої точки.

Це не твердження про «давність» події. Якщо немає минулої точки відліку, контекст може вимагати іншої форми:

- **J'ai déjà vu ce film.** — теперішня точка відліку.
- **J'avais déjà vu ce film quand tu me l'as recommandé.** — минула точка відліку.
...
> **Увага:** *plus-que-parfait* не означає просто «ще давнішу минулу дію». Потрібна релевантна минула точка відліку, відносно якої ситуація є передуючою.
