...
- `reciprocal-constructions.md` → FR-679, FR-681.
- `reflexive-causatives.md` → FR-680.
- `coordination-unlike-categories.md` → FR-682.
- `multiple-negation.md` → FR-683.
- `multiple-questions.md` → FR-684.
- `multiple-embedding.md` → FR-685.
- `nested-relative-clauses.md` → FR-686.
- `nested-complement-clauses.md` → FR-687.
- `long-distance-dependencies.md` → FR-688.
- `agreement-intervening-phrases.md` → FR-689.
- `ambiguous-attachment.md` → FR-690.
- `grammatical-ambiguity.md` → FR-691, FR-692.
- `scope-negation-quantifiers.md` → FR-693, FR-694, FR-695.

The articles remain deliberately system-level rather than artificial micro-pages. Each has explicit canonical identity, graph relations, Ukrainian contrast where useful, examples, diagnostics, and `status: review`.
