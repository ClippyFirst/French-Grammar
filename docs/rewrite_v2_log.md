...
## B29.3 — FR-058–FR-078: іменниковий кластер зі snapshot Missing (2026-09-26)

Продовжено роботу за committed qa-output.txt. Перед створенням нових сторінок перевірено актуальне дерево master: частина snapshot Missing уже була покрита поточними canonical mappings, тому її не дубльовано.

### Вже покрито, тому НЕ створювалося заново

- FR-059 — noun-gender.md
- FR-061 — gender-patterns.md
- FR-069–FR-070 — irregular-plurals.md

### Додано 13 нових canonical articles

- FR-058 — common-proper-nouns.md
- FR-060 — semantic-gender.md
- FR-062 — irregular-gender.md
- FR-063 — person-gender.md
- FR-064 — profession-gender.md
- FR-065 — loanword-gender.md
- FR-067 — noun-number.md
- FR-068 — regular-plural.md
- FR-073 — mass-count-nouns.md
- FR-074 — abstract-concrete-nouns.md
- FR-075 — collective-nouns.md
- FR-076 — proper-person-names.md
- FR-078 — substantivation-noun.md

### Змістове рішення

Кластер побудовано навколо реальної структури іменника, а не як набір механічних правил. FR-058 розмежовує загальні та власні назви й показує, чому власна назва не означає автоматично «без артикля». FR-060–FR-065 розводять граматичний рід, семантичну стать, словотвірні підказки, нерегулярні випадки, назви осіб, професії та запозичення. FR-067–FR-068 окремо описують категорію числа та регулярну множину, не змішуючи її з нерегулярними моделями FR-069–070. FR-073 розрізняє масове й лічильне вживання як властивість конкретної інтерпретації, FR-074 — абстрактність/конкретність як семантичну класифікацію, FR-075 — колективність і питання узгодження, FR-076 — особові власні назви, FR-078 — синтаксичну субстантивацію та лексикалізацію.

У всіх нових сторінках збережено україномовний контрастивний шар, типові помилки, практичний алгоритм і мінітест. Регіональні, лексичні та контекстні варіанти не перетворювалися на універсальні правила.

### Academic Writing Toolkit QA

review_paragraph_logic виконано для всіх 13 нових сторінок:
...
У всіх перевірках єдиний тип finding — short-paragraph heuristic. Інших типів логічних або структурних проблем Toolkit не повернув. Короткі абзаци тут часто є навмисними довідниковими блоками, таблицями прикладів, алгоритмами та мінітестами.

### Лічильник

- Markdown-файлів перед B29.3: 410
- нових Markdown-файлів у B29.3: 13
- поглиблено в B29.3: 0
- Markdown-файлів після B29.3: 423
- canonical scope: 740 topic IDs

Це лічильник Markdown-файлів, а не кількість покритих canonical IDs: mapping у репозиторії не є 1:1.

### Git / verification

Кожну з 13 нових статей створено окремим Git-комітом у master. Academic Writing Toolkit перевірив усі 13 нових тексти. Локальний npm run qa / Astro build у цьому середовищі не запускався, тому зелений build не заявляється.

### Наступний крок

Продовжити зі snapshot Missing у наступному фактичному кластері FR-098–FR-138, з обов'язковою перевіркою актуального mapping перед створенням кожної нової сторінки.
